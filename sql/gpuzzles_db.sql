...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2020 at 06:50 PM
...
CREATE TABLE `gpuzzles` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'name of the generated puzzle  (eg: word_search_1, cross_word_98)',
  `creator_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Manual' COMMENT 'Application used to generate the puzzle',
  `author_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'who created this puzzle',
  `book_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'what is the name of the compilation or book in which this puzzle is going in?',
  `puzzle_image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'we will carry only the image name in DB',
  `solution_image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'we will carry only the image name in DB',
  `notes` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'to capture any misc. notes'
...
(308, 'Testing Puzzle ABC', 'Test Puzzles ABC', 'Tester ', 'Testing Puzzles Vol 123', 'test.png', 'test2.png', 'This is a test. ABC');
...
(1, 'NO_OF_PUZZLES_TO_SHOW ', 12, 'This is the number of puzzles to show on home page.'),
(2, 'NO_OF_PUZZLES_PER_ROW ', 3, 'The number of puzzles per row to show on home page.');
...
--
ALTER TABLE `gpuzzles`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=310;
COMMIT;
